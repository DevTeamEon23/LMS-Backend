...
def add_test(test_name: str = Form(...), course_id: int = Form(...), user_id: int = Form(...), question: str = Form(...), option_a: str = Form(...), option_b: str = Form(...), option_c: str = Form(...), option_d: str = Form(...), correct_answer: str = Form(...), marks: int = Form(...), user_selected_answer: str = Form(...), active: bool = Form(...)):
    try:
        inputs = {
            'test_name': test_name,
            'course_id': course_id,
